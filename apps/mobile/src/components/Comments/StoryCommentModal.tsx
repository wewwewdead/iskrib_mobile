...
import {useStoryChapterComments} from '../../hooks/useStoryChapterComments';
...
export function StoryCommentModal({
  ...
  const {
    ...
    submitComment,
    isSubmitting,
  } = useStoryChapterComments(chapterId, paragraphIndex, paragraphFingerprint, onReplyActivated);

  const visibleComments = useMemo(
    () =>
      buildVisibleCommentThread(
        comments as unknown as JournalComment[],
        fetchedReplies as unknown as Record<string, JournalComment[]>,
        expandedReplies,
        loadingReplies,
      ),
  ...
  return (
    <Modal
      ...
      <SafeAreaView style={[styles.container, {backgroundColor: colors.bgPrimary}]}>
        ...
        {/* Paragraph preview */}
        {paragraphPreview ? (
          <View style={[styles.previewBanner, {borderLeftColor: colors.accentAmber, backgroundColor: colors.bgSecondary}]}>
            <Text
